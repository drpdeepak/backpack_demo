...
class UserCrudController extends CrudController
{
    public function setup()
    {
        ...
        $this->crud->addButtonFromView('line', 'user_approve', 'user_approve', 'beginning');
        $this->crud->removeButton( 'update' );
         $this->crud->addButtonFromView('line', 'change_passsword', 'change_passsword', 'end');
       $this->crud->addButtonFromView('line', 'profile_view', 'profile_view', 'end');
       // $this->crud->addButtonFromView('line', 'diary_log', 'diary_log', 'end');
	     ...
	     //$this->crud->setRoute("admin/user/".$user_id."/approve");
        ...
        //$this->crud->addButton('line', 'app', 'button', 'dkhf', 'end');
