...
/*********************user register routes*******************************/
   ...
   // Route::post('thankyou', 'UserController@register');
...
/************************Add Slider Routes*************************************/  
   ...
   // CRUD::resource('role', '\Backpack\PermissionManager\app\Http\Controllers\RoleCrudController');
    ...
    CRUD::resource('offers', 'Admin\OfferCrudController');  
    ...
    Route::post('order/deleteorder', 'OrderController@deleteorder')->name('deleteorder');
    ...
    Route::group(['prefix' =>  'vendor', 'middleware' =>  ['role:Administrator,access_backend']], function () {
